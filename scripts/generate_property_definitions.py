...
PROPERTY_GROUP_NAMESPACE_NAMES_SCAPI = {
    "vehicle": "sc_api::sim_data::vehicle",
    "sim": "sc_api::sim_data::sim",
    "participant": "sc_api::sim_data::participant",
    "track": "sc_api::sim_data::track",
    "tire": "sc_api::sim_data::tire",
    "session": "sc_api::sim_data::session",
}
