...
namespace std {
template <>
struct hash<sc_api::DeviceSessionId> {
    std::size_t operator()(const sc_api::DeviceSessionId& s) const noexcept { return std::hash<uint16_t>()(s.id); }
};
}  // namespace std

#endif  // SC_API_DEVICE_H_
